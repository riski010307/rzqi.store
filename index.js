...
/////////////////
const BotName = 'RIZQI BOT☄'; 
const instagram = 'https://instagram.com/rzqi.store6'; 
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@rzqi.store6')
